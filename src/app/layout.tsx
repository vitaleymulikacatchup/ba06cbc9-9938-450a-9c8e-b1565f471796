...
export const metadata: Metadata = {
  title: "Огурчик - Натуральный сок из огурцов | 100% органический",
  description: "Огурчик - премиальный натуральный сок из свежих огурцов без консервантов. Богат витаминами и полезными веществами. Доставка по России.",
  keywords: "огуречный сок, натуральный сок, органический сок, здоровое питание, витамины",
  openGraph: {
    title: "Огурчик - Натуральный сок из огурцов",
    description: "Свежие соки из отборных огурцов без консервантов и искусственных добавок",
    siteName: "Огурчик",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763466235070-lz6eehgo.jpg",
        alt: "Натуральный сок Огурчик"
      }
    ]
  },
  twitter: {
    ...
    title: "Огурчик - Натуральный сок из огурцов",
    description: "Свежие соки из отборных огурцов без консервантов и искусственных добавок",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763466235070-lz6eehgo.jpg"]
  },
  robots: {
    index: true,
    follow: true
